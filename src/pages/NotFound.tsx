  ...
  return (
    <main id="main" className="min-h-[78vh] pt-[8rem] md:pt-[11rem]">
      ...
      <div className="atlas-grid mt-10 md:mt-16">
        ...
        <p className="col-span-4 mt-8 max-w-[42ch] text-read-lg text-graphite md:col-span-5 xl:col-span-5">
        ...
        <div className="col-span-4 mt-10 md:col-span-4 xl:col-span-4">
          <Link to="/" className="link-underline mono-label inline-flex items-center gap-2 text-ink">
