  ...
  return (
    <main id="main" className="min-h-[78vh] pt-[8rem] md:pt-[11rem]">
      ...
      <div className="atlas-grid mt-10 md:mt-16">
        ...
        <p className="col-span-4 mt-8 max-w-[42ch] text-body-lg text-graphite md:col-span-5 xl:col-span-5">
          The requested coordinate is not part of this atlas. The route may have moved, or it may
          never have existed.
        </p>
