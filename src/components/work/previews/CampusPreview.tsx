...
export function CampusPreview() {
  ...
  return (
    <svg viewBox="0 0 520 300" className="h-full w-full" role="img" aria-label="Navigation preview: three stacked floor plates with a route continuing between levels">
      ...
      <text x="352" y="80" fontFamily="Geist Mono, monospace" fontSize="9" letterSpacing="1.4" fill="var(--graphite)">
        L3 / ROOM
      </text>
      <text x="20" y="248" fontFamily="Geist Mono, monospace" fontSize="9" letterSpacing="1.4" fill="var(--graphite)">
        L1 / ENTRANCE
      </text>
