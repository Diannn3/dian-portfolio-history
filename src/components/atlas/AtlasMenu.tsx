...
export function AtlasMenu() {
  ...
  /** Close and navigate through the router so RouteLifecycle owns hash scrolling. */
          ...
          <div ref={panel} className="relative min-h-full">
            ...
            <div className="atlas-grid relative gap-y-12 pb-16 pt-6">
              <div className="col-span-4 md:col-span-5 xl:col-span-7">
                ...
                <Dialog.Description className="sr-only">Project and section index for the Vector Atlas portfolio.</Dialog.Description>
                <ul>
                  ...
                  <li key={p.slug}>
                      ...
                      onMouseEnter={() => { preloadProjectPage(); preloadProject(p.slug); }}
                      onFocus={() => { preloadProjectPage(); preloadProject(p.slug); }}
