...
import { useCompact, useReducedMotion } from '../../hooks/useEnvironment';
...
export function SplineStudy() {
  ...
  const shouldMount = configured && near && !reduced && !compact;
        ...
        <div className="aspect-[16/10] w-full">
          ...
          <div className="flex h-full w-full items-center justify-center p-6">
              <div className="max-w-[46ch] text-center">
                <p className="mono-label text-accent">NO SCENE CONFIGURED</p>
                <p className="mt-3 text-read-sm text-graphite">
                  {configured ?
                reduced || compact ?
                'A scene exists but is not mounted here: reduced motion or a compact viewport keeps this slot static.' :
