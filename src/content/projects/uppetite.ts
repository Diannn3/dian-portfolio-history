...
export const project: Project = {
    ...
    leadMedia: {
      ...
      fit: 'cover',
      priority: true,
      proves: 'A real product state: route-aware discovery with explicit time and preference constraints.',
      capturedAt: '2026-08-20 audit derivative from a committed repository visual baseline',
      dataState: 'DETERMINISTIC MOBILE BASELINE / PUBLIC-SAFE',
      source: 'UPPETITE repository: app/tests/e2e/visual.spec.ts-snapshots/smart-picks-list-mobile-390-visual-chromium-win32.png',
    },
    technologies: [
    ...
    modules: [
      ...
      },
      {
        ...
        media: [
          {
            type: 'image',
            src: '/work/uppetite/explore-mobile.webp',
            alt: 'UPPETITE Explore mobile view showing search, category filters, list-map controls and local place results.',
            caption: 'Explore keeps search, filters and list-map discovery on the same structured place records.',
            width: 780,
            height: 2400,
            aspectRatio: '16 / 10',
            fit: 'cover',
            proves: 'A supporting product state: discovery controls and place results in the public interface.',
            capturedAt: '2026-08-20 audit derivative from a committed repository visual baseline',
            dataState: 'DETERMINISTIC MOBILE BASELINE / PUBLIC-SAFE',
            source: 'UPPETITE repository: app/tests/e2e/visual.spec.ts-snapshots/explore-results-mobile-390-visual-chromium-win32.png',
          },
        ],
      },
      {
